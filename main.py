...
async def download(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🔄 *Processing your link... Please wait*", parse_mode="Markdown")
    ...
    try:
        ...
        logging.error(e)
        await update.message.reply_text("🚫 *Oops! An error occurred while processing the link.*", parse_mode="Markdown", reply_markup=get_buttons())
